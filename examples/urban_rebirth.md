...
- 主角每次获利都要伴随新的风险、失败代价或对手注意。
- 章尾必须落到下一章可执行的具体压力，不能只写宏大商业方向。
  ...
  "expected_checks": {
    ...
    "plot": {
      ...
      "chapter_1": {
        ...
        "required_events": ["重生", "外卖站危机", "避开事故", "外部阻力"]
      }
    },
    "character": {
    ...
    "writer": {
      ...
      "must_include": ["暴雨或配送压力", "站点责任", "主角主动决策", "外部阻力", "失败代价", "下一步压力"],
      "forbidden": ["长篇前世流水账", "无代价碾压", "合作无阻力谈成", "只讲趋势不写场景", "我要建立商业帝国"]
    },
    "continuity": {
    ...
    "style": {
      ...
      "forbidden": ["机械商业分析", "只讲趋势不写场景", "合作无阻力谈成", "我要建立商业帝国"]
    },
    "review": {
      "pass_line": {
        "total_score": 75,
